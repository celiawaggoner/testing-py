...
def most_and_least_common_type(treats):
    ...
    #test with only one type of treat
    >>> one_treat = [{'type': 'dessert'}, {'type': 'dessert'}]
    >>> most_and_least_common_type(one_treat)
    ('dessert', 'dessert')

    #test with a tie of treats
    >>> treat_with_tie = [{'type': 'dessert'}, {'type': 'drink'}]
    >>> most_and_least_common_type(treat_with_tie)
    ('dessert', 'dessert')

    #test with None as value
    >>> no_value_treat = [{'type': None }]
    >>> most_and_least_common_type(no_value_treat)
    (None, None)
